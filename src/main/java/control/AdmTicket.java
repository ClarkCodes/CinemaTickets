...
{   // Atributos - Propiedades
    private HashMap<String, Ticket> tickets = null; // Coleccion HashMap Principal donde estarï¿½n almacenados los registros primordiales como objetos, en este caso de Tickets.
    private Ticket ticket = null; // Objeto Ticket declarado pero no inicializado(por eso es null o nulo) para luego sï¿½ hacerlo y guardarlo como elemento en el HashMap tickets cada vez que quiera agregar un elemento.
